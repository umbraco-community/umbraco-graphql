...
namespace Our.Umbraco.GraphQL.Forms.Types
{
    public static class UmbracoFormsGraphTypeExtensions
    {
        public static void AddBuiltinFields(this ComplexGraphType<Form> graphType)
        {
            ...
            graphType.Field<NonNullGraphType<ListGraphType<PageGraphType>>>().Name("pages").Metadata(nameof(MemberInfo), GetMember((Form x) => x.Pages)).Resolve(ctx => ctx.Source.Pages);
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("indicator").Metadata(nameof(MemberInfo), GetMember((Form x) => x.Indicator)).Resolve(ctx => ctx.Source.Indicator);
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("requiredErrorMessage").Metadata(nameof(MemberInfo), GetMember((Form x) => x.RequiredErrorMessage)).Resolve(ctx => ctx.Source.RequiredErrorMessage);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("invalidErrorMessage").Metadata(nameof(MemberInfo), GetMember((Form x) => x.InvalidErrorMessage)).Resolve(ctx => ctx.Source.InvalidErrorMessage);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("messageOnSubmit").Metadata(nameof(MemberInfo), GetMember((Form x) => x.MessageOnSubmit)).Resolve(ctx => ctx.Source.MessageOnSubmit);
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("xPathOnSubmit").Metadata(nameof(MemberInfo), GetMember((Form x) => x.XPathOnSubmit)).Resolve(ctx => ctx.Source.XPathOnSubmit);
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("cssClass").Metadata(nameof(MemberInfo), GetMember((Form x) => x.CssClass)).Resolve(ctx => ctx.Source.CssClass);
        ...
        {
            graphType.Field<NonNullGraphType<ListGraphType<FieldSetGraphType>>>().Name("FieldSets").Metadata(nameof(MemberInfo), GetMember((Page x) => x.FieldSets)).Resolve(ctx => ctx.Source.FieldSets);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("Caption").Metadata(nameof(MemberInfo), GetMember((Page x) => x.Caption)).Resolve(ctx => ctx.Source.Caption);
        ...
        public static void AddBuiltinFields(this ComplexGraphType<FormDataSourceDefinition> graphType)
        {
            ...
            graphType.Field<NonNullGraphType<ListGraphType<FormDataSourceMappingGraphType>>>().Name("Mappings").Metadata(nameof(MemberInfo), GetMember((FormDataSourceDefinition x) => x.Mappings)).Resolve(ctx => ctx.Source.Mappings);
        }

        public static void AddBuiltinFields(this ComplexGraphType<FieldSet> graphType)
        {
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("Caption").Metadata(nameof(MemberInfo), GetMember((FieldSet x) => x.Caption)).Resolve(ctx => ctx.Source.Caption);
            ...
            graphType.Field<NonNullGraphType<ListGraphType<FieldsetContainerGraphType>>>().Name("Containers").Metadata(nameof(MemberInfo), GetMember((FieldSet x) => x.Containers)).Resolve(ctx => ctx.Source.Containers);
            graphType.Field<NonNullGraphType<FieldConditionGraphType>>().Name("Condition").Metadata(nameof(MemberInfo), GetMember((FieldSet x) => x.Condition)).Resolve(ctx => ctx.Source.Condition);
        }
        ...
        public static void AddBuiltinFields(this ComplexGraphType<FormDataSourceMapping> graphType)
        {
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("defaultValue").Metadata(nameof(MemberInfo), GetMember((FormDataSourceMapping x) => x.DefaultValue)).Resolve(ctx => ctx.Source.DefaultValue);
        }
        ...
        public static void AddBuiltinFields(this ComplexGraphType<Field> graphType)
        {
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("placeholder").Metadata(nameof(MemberInfo), GetMember((Field x) => x.Placeholder)).Resolve(ctx => ctx.Source.Placeholder);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("cssClass").Metadata(nameof(MemberInfo), GetMember((Field x) => x.CssClass)).Resolve(ctx => ctx.Source.CssClass);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("alias").Metadata(nameof(MemberInfo), GetMember((Field x) => x.Alias)).Resolve(ctx => ctx.Source.Alias);
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("requiredErrorMessage").Metadata(nameof(MemberInfo), GetMember((Field x) => x.RequiredErrorMessage)).Resolve(ctx => ctx.Source.RequiredErrorMessage);
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("invalidErrorMessage").Metadata(nameof(MemberInfo), GetMember((Field x) => x.InvalidErrorMessage)).Resolve(ctx => ctx.Source.InvalidErrorMessage);
        ...
        public static void AddBuiltinFields(this ComplexGraphType<FieldConditionRule> graphType)
        {
            ...
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("value").Metadata(nameof(MemberInfo), GetMember((FieldConditionRule x) => x.Value)).Resolve(ctx => ctx.Source.Value);
        }

        public static void AddBuiltinFields(this ComplexGraphType<KeyValuePair<string, string>> graphType)
        {
            graphType.Field<NonNullGraphType<StringGraphType>>().Name("key").Metadata(nameof(MemberInfo), GetMember((KeyValuePair<string, string> x) => x.Key)).Resolve(ctx => ctx.Source.Key);
