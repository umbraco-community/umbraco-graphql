...
namespace Our.Umbraco.GraphQL.Filters
{
    public class ContainsFilter : IFilter
    {
        ...
        public ContainsFilter(Func<object, object> valueResolver, object value)
        {
        ...
        public bool IsSatisfiedBy(object input)
        {
            ...
            return Convert.ToString(value).IndexOf(_value, StringComparison.InvariantCultureIgnoreCase) > -1;
        }
    }
}
