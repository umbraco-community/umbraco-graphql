...
namespace Our.Umbraco.GraphQL.Types
{
    public class PublishedContentDataGraphType : ObjectGraphType<IPublishedContent>
    {
        public PublishedContentDataGraphType()
        {
            ...
            Field<NonNullGraphType<PublishedContentTypeGraphType>>("contentType", "Content type of the content.")/*.SetPermissions(this, true)*/;
            ...
            //this.FilteredConnection<PublishedContentGraphType, IPublishedContent>()
            //    .Name("siblings")
